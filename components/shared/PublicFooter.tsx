...
function PublicFooter() {
  return (
    <footer className="border-t bg-background w-full md:max-w-7xl  p-4 rounded-2xl mx-auto mt-10 ">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold mb-2">Kicks</h3>
            <p className="text-sm text-muted-foreground">Kicks is a modern, responsive e-commerce web application for buying and selling shoes and fashion products online.</p>
          </div>
          <div>
